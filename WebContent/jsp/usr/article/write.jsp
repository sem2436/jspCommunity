...
<body>
	<h1>게시물 작성페이지</h1>
	<div>
		<form action="doWrite" method="POST"></form>
		...
		<div>
			<div>내용</div>
			<div><textarea name="body" maxlength="5000" placeholder="내용을 입력하세요."></textarea></div>
		</div>
		<div>
			<div>
				<input type="submit" value="작성"/>
				<button type="button" onclick="history.back();R">뒤로가기</button>
			</div>
		</div>
	</div>
</body>
